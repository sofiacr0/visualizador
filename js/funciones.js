...
function pasos() {
  ...
  if (checarJaque(tokens[i])) {
    out.innerText += ", ";
    var jaqueElement = document.createElement("span");
    jaqueElement.innerText = "Jaque";
    jaqueElement.classList.add("jaque");
    out.appendChild(jaqueElement);
  } else if (checarJaqueMate(tokens[i])) {
    out.innerText += ", ";
    var jaqueMateElement = document.createElement("span");
    jaqueMateElement.innerText = "Jaque Mate";
    jaqueMateElement.classList.add("jaque-mate");
